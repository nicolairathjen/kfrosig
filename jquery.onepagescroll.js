	...
	$(document).ready(function() {
		...
		if(Modernizr.touch === false && $(window).width() > 800) {
			...
			if (e.keyCode == 40 || e.keyCode == 39) {
			    ...
			    console.log($carousel.find('.vc-row-wrapper.slick-slide.slick-active').next('.slick-slide').height());
			    console.log($carousel.find('.vc-row-wrapper.slick-slide.slick-active').next('.slick-slide').scrollTop());
			    console.log($carousel.find('.vc-row-wrapper.slick-slide.slick-active').height());
			    if ($(window).scrollTop() + $(window).height() == $(document).height()) {
				if($carousel.find('.vc-row-wrapper.slick-slide.slick-active').next('.slick-slide').length > 0) {
				    e.preventDefault();
				    $(window).stop().animate({scrollTop: 0}, 'fast');
